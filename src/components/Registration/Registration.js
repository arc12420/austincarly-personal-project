...
class Registration extends Component {
  ...
  register =() => {
    ...
    axios.post("/api/addUser", {firstName, lastName, email, password, profilePic})
    .then((res) => {
        ...
        <img src={logo} className="registrationLogo" alt="Logo" />
          ...
          <div className="inputsAndButtons">
            <div className="registrationInputs">
              ...
              <input onChange={(event) => this.handleProfilePic(event.target.value)} placeholder="Profile Picture URL" />
            </div>
